...
public class Assignment5 {
	 ...
	 * making input and output streams, and writing some useful information to the
	 * output area in the GUI.
	 */
	private void onAlgorithmRun() {
		try {
			...
			if (algorithm.equals("Huffman coding")) {
				...
				List<String> lines = Arrays.asList(decoded);
	...
	private void initialise() {
		...
		searchField.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int index = kmp.index;
				System.out.println("KMP Map: " + kmp.matchTable);
				System.out.println("KMP: " + kmp.steps + " " + kmp.stepsWithoutMap);
				System.out.println("BFS: " + new BruteForceSearch(pattern, text).steps);
